...
\chapter{More on rings}
\label{chapter:more-on-rings}
\subfile{chapter-more-on-rings.tex}

\chapter{Ring homomorphisms}
\label{chapter:ring-homomorphisms}
\subfile{chapter-ring-homomorphisms.tex}
