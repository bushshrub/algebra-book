...
relation $x \sim y$ if and only if $x \mod 3 = y \mod 3$. This partitions $\bZ$ into the following sets:
\begin{align*}
...
stuff in the set $1 + 3\bZ$ to themselves, we also obtain $2 + 3\bZ$.
...
leave this as a good exercise in \cref{thm:existence-of-quotient-groups}.
